package com.ripstech.apiconnector2.entity.send.quota;

import com.fasterxml.jackson.annotation.JsonRootName;

import java.util.Optional;

@JsonRootName(value = "acl")
public class AclSend {
	...
	public AclSend setUse(Boolean use) {
	...
	public Optional<Boolean> getUse() {
		return this.use;
	}
